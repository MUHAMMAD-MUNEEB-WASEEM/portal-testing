...
import { getOneInvoice, sendInvoice } from '../../../redux/invoiceSlice';
  ...
  return (
    <VStack spacing="6" align="stretch" p="4">
      <Flex mb={6} justifyContent="space-between" alignItems="end">
        ...
        <Flex gap={2}>
          <Button bg={'brand.secondary'} onClick={handlePrint}>
            Print
          </Button>
          <Button bg={'brand.secondary'} onClick={handleSendInvoice}>
            Send Invoice
          </Button>
