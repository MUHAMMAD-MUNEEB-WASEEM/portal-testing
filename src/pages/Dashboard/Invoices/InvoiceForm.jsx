...
import { getOneClient, setSingleClientNull, getUserClients } from '../../../redux/clientSlice';
import { addInvoice, getOneInvoice, updateInvoice } from '../../../redux/invoiceSlice';
...
const InvoiceForm = () => {
  ...
  const clientSelectHandler = (e) => {
    ...
    dispatch(getOneClient({ id: e.value })).then((res) => {
  ...
  const formHandler = (e) => {
    e.preventDefault();
    dispatch(addInvoice({ payload: invoice }))
      .then((action) => {
        if (addInvoice.fulfilled.match(action)) {
          if (action.payload) {
    ...
    <VStack spacing="6" align="stretch" p="4">
      <form onSubmit={formHandler}>
        ...
        <Flex flexDir={'column'} gap={10}>
          <Box w={'50%'} color={'brand.secondary'}>
            <FormControl my="10px">
            ...
            >
              <Box color={'black'} as="div" zIndex={10}>
                <Flex justifyContent={'space-between'}>
                  ...
                  >
                    <Box as="div">
                      ...
                      <Text>{`${client?.brand?.invoicePrefix}-${
                ...
                <Box as="div">
                  ...
                  <Button bg={'brand.secondary'} onClick={handleAdd}>
                    Add Item
                  </Button>
