            ...
            <Tbody className='bg-white text-gray-800'>
              {invoices?.map((e, i) => (
                <Tr key={i} style={{ cursor: 'pointer' }}>
                  <Td>
                    <Text textTransform="capitalize">{`${e?.invoiceNumber}`}</Text>
                  </Td>
                  <Td>
                    <Text>
                  ...
                  <Td>
                    <Text>{e?.clientEmail}</Text>
                  </Td>
                  <Td>
                    <Text textTransform={'capitalize'}>{e?.status}</Text>
                  </Td>

                  <Td>
                    <Text textTransform={'capitalize'}>{e?.brandName} </Text>
                  </Td>

                  <Td>
                    <Text textTransform={'capitalize'}>{e?.user?.name} </Text>
                  </Td>
